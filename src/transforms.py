...
MATCHED_PARTS = {
    ...
    "AFLW":
    ([1, 6], [2, 5], [3, 4], [7, 12], [8, 11], [9, 10], [13, 15], [16, 18]),
...
def crop(img, center, scale, output_size, rot=0):
    ...
    # Upper left point
    ul = np.array(
        transform_pixel([0, 0], center_new, scale, output_size, invert=1))
    # Bottom right point
    br = np.array(
        transform_pixel(output_size, center_new, scale, output_size, invert=1))
